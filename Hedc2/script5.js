...
if (passesEveningFilter && passesReductionFilter) {
    ...
    console.log("Customer added:", customerResult); // این خط را حفظ کنید
}
// } <--- این براکت بسته شدن حلقه for (let i = 0; i < dataRows.length; i++) است
//} // End of for loop

console.log("Final parsedData after processing:", parsedData); // این خط را اضافه کنید
